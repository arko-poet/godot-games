...
func _start_dragging() -> void:
	...
	var data: Dictionary = _create_drag_data(preview)
	force_drag.call_deferred(data, preview)

@abstract func _create_drag_preview() -> Control
	
@abstract func _create_drag_data(drag_preview: Control) -> Dictionary
